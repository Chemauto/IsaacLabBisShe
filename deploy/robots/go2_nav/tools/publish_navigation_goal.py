...
def main() -> None:
    parser = argparse.ArgumentParser(description="Continuously publish a navigation goal to rt/navigation_goal.")
    parser.add_argument("--domain-id", type=int, default=0)
    parser.add_argument("--interface", type=str, default="lo")
    parser.add_argument("--topic", type=str, default="rt/navigation_goal")
    parser.add_argument("--rate", type=float, default=10.0, help="Publish rate in Hz. Keep this above 5 Hz.")
    parser.add_argument(
        "--goal",
        type=float,
        nargs=4,
        ...
        help="World-frame navigation goal [x y z yaw].",
    )
    ...
    print(f"Publishing navigation goal to {args.topic}")
