...
void init_fsm_state()
{
    ...
    const auto push_box_cfg = param::config["FSM"]["PushBox"];
    if (push_box_cfg && push_box_cfg["height_map_topic"]) {
        height_map_topic = push_box_cfg["height_map_topic"].as<std::string>();
    }
...
int main(int argc, char** argv)
{
    ...
    std::cout << "     Go2 Push-Box Controller \n";
    ...
    std::cout << "And then press [Start] to start push-box control.\n";
