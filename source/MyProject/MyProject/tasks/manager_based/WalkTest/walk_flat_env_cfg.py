...
class EventCfg:
    ...
    physics_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.2, 1.2),#原本0.8
            "dynamic_friction_range": (0.2, 1.2),#原本0.6
    ...
    base_external_force_torque = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="base"),
            "force_range": (-10.0, 10.0),#暂定给的
            "torque_range": (-3.0, 3.0),#暂定给的
        },
    )
...
@configclass
class Go2WalkFlatEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class Go2WalkFlatEnvCfg_Play(Go2WalkFlatEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""
