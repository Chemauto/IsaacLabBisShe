...
class PreTrainedPolicyAction(ActionTerm):
    r"""Pre-trained policy action term with local action scaling for PushBoxTest."""
    ...
    def IO_descriptor(self):
        """The IO descriptor for the high-level push-box action term."""
...
class PreTrainedPolicyActionCfg(ActionTermCfg):
    """Configuration for local pre-trained policy action term."""
