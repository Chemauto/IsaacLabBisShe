...
gym.register(
    id="Template-Manual-Rough-Go2-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.manual_rough_env_cfg:LocomotionManualRoughEnvCfg",
...
gym.register(
    id="Template-Manual-Rough-Go2-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.manual_rough_env_cfg:LocomotionManualRoughEnvCfg_Play",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:ManualRoughPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_manual_rough_ppo_cfg.yaml",
    },
)
